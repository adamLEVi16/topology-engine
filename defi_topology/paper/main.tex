...
Survivorship, LP Representation, and a Robust Null\par}
\vspace{1.2em}
...
rising survivorship rate (grey, right axis), i.e.\ it is the survivor sample converging to
...
removes ($\to48$, green), leaving the window inert. Dotted line: the exploit (2023-07-30);
